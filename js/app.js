...
async function loadArtworks() {
  try {
    ...
    const url = 'data/artworks.json?cb=' + Date.now(); // cache busting
...
function createCard(item) {
  ...
  card.innerHTML = `
    <figure>
      <img src="img/${item.cover}" alt="${item.title}" loading="lazy" width="400" height="560" />
...
function initCinemaDetails() {
  const details = [
    { title:'PERSONA', technique:'Acrylic and Spray Can on Glass', size:'60 x 70 cm', price:600, status:'sold', img:'img/20211222_144641-2.jpg' },
    { title:'VERTIGO', technique:'Acrylic and Spray Can on Glass', size:'85 x 85 cm', price:700, status:'available', img:'img/20220114_110409.jpg' },
    { title:'HIROSHIMA MON AMOUR', technique:'Acrylic and Spray Can on Glass', size:'53 x 63 cm', price:550, status:'sold', img:'img/20220206_165159-1.jpg' },
    { title:'LA DOLCE VITA', technique:'Acrylic and Spray Can on Glass', size:'84 x 74 cm', price:700, status:'sold', img:'img/20220228_170756.jpg' },
    { title:'JULES ET JIM', technique:'Acrylic and Spray Can on Glass', size:'58 x 68 cm', price:600, status:'sold', img:'img/donnauomo.jpg' },
    { title:'A BOUT DE SOUFFLE', technique:'Acrylic and Spray Can on Glass', size:'73 x 63 cm', price:600, status:'sold', img:'img/donnauomo2.jpg' }
  ];
...
function initPolaroidDetails() {
  const details = [
    { title:'CUTRONE', technique:'Acrilyc on Canvas and Photographic Print on Board', subtitle:'Cats Regning', size:'50 x 70 cm', price:700, status:'sold', img:'img/IMG_2104-scaled.jpeg' },
    { title:'BASQUIAT', technique:'Acrilyc on Canvas and Photographic Print on Board', subtitle:'Birds on Money', size:'50 x 70 cm', price:700, status:'sold', img:'img/IMG_2105-1364x2048.jpeg' },
    { title:'HOCKNEY', technique:'Acrilyc on Canvas and Photographic Print on Board', subtitle:'Peter getting out of Nick’s Pool', size:'50 x 70 cm', price:700, status:'sold', img:'img/IMG_2108-1299x2048.jpeg' },
    { title:'HARING', technique:'Acrilyc on Canvas and Photographic Print on Board', subtitle:'Safe Sex', size:'50 x 70 cm', price:700, status:'sold', img:'img/IMG_2109-scaled.jpeg' },
    { title:'WARHOL', technique:'Acrilyc on Canvas and Photographic Print on Board', subtitle:'Shot Marilyns', size:'50 x 70 cm', price:700, status:'sold', img:'img/andy.jpeg' },
    { title:'DALÌ', technique:'Acrilyc on Canvas and Photographic Print on Board', subtitle:'The Disintegration of the Persistence of Memory', size:'50 x 70 cm', price:700, status:'sold', img:'img/dali.jpeg' },
    { title:'BACON', technique:'Acrilyc on Canvas and Photographic Print on Board', subtitle:'Self Portrait 1971', size:'50 x 70 cm', price:700, status:'sold', img:'img/bacon.jpeg' },
    { title:'LICHTENSTEIN', technique:'Acrilyc on Canvas and Photographic Print on Board', subtitle:'M-Maybe 1965', size:'50 x 70 cm', price:700, status:'sold', img:'img/linch.jpeg' }
  ];
